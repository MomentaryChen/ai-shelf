...
- Screenshot order and filenames are generated by `tests/e2e/screenshot.spec.ts` into `tests/screenshots/en/` (this page) and `tests/screenshots/zh/` ([pages.zh-TW.md](pages.zh-TW.md)).
