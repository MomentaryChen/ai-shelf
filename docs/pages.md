...
- Regenerate all README/docs images before a release: **Actions → Docs assets** on Windows CI (canonical), or `pnpm gen:docs-assets` for local preview — see [RELEASE.md](RELEASE.md).
