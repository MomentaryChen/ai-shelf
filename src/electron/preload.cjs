...
contextBridge.exposeInMainWorld("api", {
  ...
  getTeamPolicy: () => ipcRenderer.invoke("get-team-policy"),
  setTeamPolicy: (policy) => ipcRenderer.invoke("set-team-policy", policy),
  evaluateTeamPolicy: () => ipcRenderer.invoke("evaluate-team-policy"),
  getConfigAlignGaps: (opts) => ipcRenderer.invoke("get-config-align-gaps", opts),
  alignConfigFromSource: (opts) => ipcRenderer.invoke("align-config-from-source", opts),
  importTeamPolicy: () => ipcRenderer.invoke("import-team-policy"),
  exportTeamPolicy: () => ipcRenderer.invoke("export-team-policy"),
